...
// const DataRecord *Hash::sel(const char *cpf, bool toDelete)
// {
...
// std::vector<const DataRecord *>Hash::selMultiple(const char **cpfs, const int quant)
// {
//   const DataRecord *record;
...
// std::vector<const DataRecord *>Hash::selRange(const char *cpfBegin, const char *cpfEnd)
// {
